...
const withAverage = students.map(student => {
  ...
  let average = (sum / student.marks.length).toFixed(3);
...
// const averageOfAveragees = withAverage.reduce((averageClass, current) => {
//   averageClass += current;
//   return averageClass / 3;
// });
// console.log(averageOfAveragees);
